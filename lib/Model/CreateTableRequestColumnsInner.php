...
/**
 * CreateTableRequestColumnsInner Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateTableRequestColumnsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createTable_request_columns_inner';
    ...
    protected static $openAPITypes = [
        ...
        'column_data' => '\SeaTable\Client\Model\ButtonColumnFormat'
    ];
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling CreateTableRequestColumnsInner., must conform to the pattern /^[^.}{`]*$/.");
        }
     ...
     * Gets column_data
     *
     * @return \SeaTable\Client\Model\ButtonColumnFormat
     */
     ...
     * Sets column_data
     *
     * @param \SeaTable\Client\Model\ButtonColumnFormat $column_data column_data
     *
     * @return self
     */
