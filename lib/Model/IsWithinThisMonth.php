...
/**
 * IsWithinThisMonth Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinThisMonth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_this_month';
    ...
    public const FILTER_TERM_MODIFIER_THIS_MONTH = 'this_month';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THIS_MONTH,
        ];
    }
