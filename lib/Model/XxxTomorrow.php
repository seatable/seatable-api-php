 ...
 */
class XxxTomorrow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'xxx_tomorrow';
    ...
    public const FILTER_TERM_MODIFIER_TOMORROW = 'tomorrow';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_TOMORROW,
        ];
    }
