...
/**
 * IsCurrentUserID Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsCurrentUserID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_current_user_ID';
    ...
    public const FILTER_PREDICATE_IS_CURRENT_USER_ID = 'is_current_user_ID';
    ...
    {
        return [
            self::FILTER_PREDICATE_IS_CURRENT_USER_ID,
        ];
    }
