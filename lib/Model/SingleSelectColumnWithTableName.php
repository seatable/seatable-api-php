...
/**
 * SingleSelectColumnWithTableName Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class SingleSelectColumnWithTableName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'single_select_column_with_table_name';
    ...
    public const COLUMN_TYPE_SINGLE_SELECT = 'single-select';
    ...
    {
        return [
            self::COLUMN_TYPE_SINGLE_SELECT,
        ];
    }
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling SingleSelectColumnWithTableName., must conform to the pattern /^[^.}{`]*$/.");
        }
