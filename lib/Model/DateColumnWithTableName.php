...
/**
 * DateColumnWithTableName Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class DateColumnWithTableName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'date_column_with_table_name';
    ...
    protected static $openAPITypes = [
        ...
        'column_data' => '\SeaTable\Client\Model\DateColumnFormat'
    ];
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling DateColumnWithTableName., must conform to the pattern /^[^.}{`]*$/.");
        }
     ...
     * Gets column_data
     *
     * @return \SeaTable\Client\Model\DateColumnFormat|null
     */
     ...
     * Sets column_data
     *
     * @param \SeaTable\Client\Model\DateColumnFormat|null $column_data column_data
     *
     * @return self
     */
