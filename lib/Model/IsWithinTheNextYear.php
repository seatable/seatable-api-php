...
/**
 * IsWithinTheNextYear Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinTheNextYear implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_the_next_year';
    ...
    public const FILTER_TERM_MODIFIER_THE_NEXT_YEAR = 'the_next_year';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THE_NEXT_YEAR,
        ];
    }
