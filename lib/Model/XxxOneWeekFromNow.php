...
/**
 * XxxOneWeekFromNow Class Doc Comment
 *
 * @category Class
 ...
 */
class XxxOneWeekFromNow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'xxx_one_week_from_now';
    ...
    public const FILTER_TERM_MODIFIER_ONE_WEEK_FROM_NOW = 'one_week_from_now';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_ONE_WEEK_FROM_NOW,
        ];
    }
