...
/**
 * IsWithinThisYear Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinThisYear implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_this_year';
    ...
    public const FILTER_TERM_MODIFIER_THIS_YEAR = 'this_year';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THIS_YEAR,
        ];
    }
