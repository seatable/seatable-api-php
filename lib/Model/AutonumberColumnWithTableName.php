...
/**
 * AutonumberColumnWithTableName Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class AutonumberColumnWithTableName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'autonumber_column_with_table_name';
    ...
    protected static $openAPITypes = [
        ...
        'column_data' => '\SeaTable\Client\Model\AutonumberColumnFormat'
    ];
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling AutonumberColumnWithTableName., must conform to the pattern /^[^.}{`]*$/.");
        }
     ...
     * Gets column_data
     *
     * @return \SeaTable\Client\Model\AutonumberColumnFormat|null
     */
     ...
     * Sets column_data
     *
     * @param \SeaTable\Client\Model\AutonumberColumnFormat|null $column_data column_data
     *
     * @return self
     */
