...
/**
 * XxxOneMonthFromNow Class Doc Comment
 *
 * @category Class
 ...
 */
class XxxOneMonthFromNow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'xxx_one_month_from_now';
    ...
    protected static $openAPITypes = [
        ...
        'filter_term' => '\SeaTable\Client\Model\FilterTermEmpty',
    ...
    public const FILTER_PREDICATE_IS = 'is';
    public const FILTER_PREDICATE_IS_BEFORE = 'is_before';
    public const FILTER_PREDICATE_IS_AFTER = 'is_after';
    public const FILTER_PREDICATE_IS_ON_OR_BEFORE = 'is_on_or_before';
    public const FILTER_PREDICATE_IS_ON_OR_AFTER = 'is_on_or_after';
    public const FILTER_PREDICATE_IS_NOT = 'is_not';
    public const FILTER_TERM_MODIFIER_ONE_MONTH_FROM_NOW = 'one_month_from_now';
    ...
    {
        return [
            self::FILTER_PREDICATE_IS,
            self::FILTER_PREDICATE_IS_BEFORE,
            self::FILTER_PREDICATE_IS_AFTER,
            self::FILTER_PREDICATE_IS_ON_OR_BEFORE,
            self::FILTER_PREDICATE_IS_ON_OR_AFTER,
            self::FILTER_PREDICATE_IS_NOT,
        ];
    }
     ...
     * @return string[]
     */
    public function getFilterTermModifierAllowableValues()
    {
        return [
            self::FILTER_TERM_MODIFIER_ONE_MONTH_FROM_NOW,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getFilterTermModifierAllowableValues();
        if (!is_null($this->container['filter_term_modifier']) && !in_array($this->container['filter_term_modifier'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'filter_term_modifier', must be one of '%s'",
                $this->container['filter_term_modifier'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Gets filter_term
     *
     * @return \SeaTable\Client\Model\FilterTermEmpty|null
     */
     ...
     * Sets filter_term
     *
     * @param \SeaTable\Client\Model\FilterTermEmpty|null $filter_term filter_term
     *
     * @return self
     */
    ...
    public function setFilterTermModifier($filter_term_modifier)
    {
        ...
        $allowedValues = $this->getFilterTermModifierAllowableValues();
        if (!in_array($filter_term_modifier, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'filter_term_modifier', must be one of '%s'",
