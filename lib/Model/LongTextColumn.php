...
/**
 * LongTextColumn Class Doc Comment
 *
 * @category Class
 ...
 */
class LongTextColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'long_text_column';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling LongTextColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
