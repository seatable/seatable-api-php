...
/**
 * LinkFormulaColumnWithTableName Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class LinkFormulaColumnWithTableName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'link_formula_column_with_table_name';
    ...
    protected static $openAPITypes = [
        ...
        'column_data' => '\SeaTable\Client\Model\LinkFormulaColumnColumnData'
    ];
    ...
    public const COLUMN_TYPE_LINK_FORMULA = 'link-formula';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling LinkFormulaColumnWithTableName., must conform to the pattern /^[^.}{`]*$/.");
        }
     ...
     * Gets column_data
     *
     * @return \SeaTable\Client\Model\LinkFormulaColumnColumnData
     */
     ...
     * Sets column_data
     *
     * @param \SeaTable\Client\Model\LinkFormulaColumnColumnData $column_data column_data
     *
     * @return self
     */
