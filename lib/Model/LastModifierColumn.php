...
/**
 * LastModifierColumn Class Doc Comment
 *
 * @category Class
 ...
 */
class LastModifierColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'last_modifier_column';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling LastModifierColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
