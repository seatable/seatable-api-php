...
/**
 * CollaboratorColumnWithTableName Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class CollaboratorColumnWithTableName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'collaborator_column_with_table_name';
    ...
    public const COLUMN_TYPE_COLLABORATOR = 'collaborator';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling CollaboratorColumnWithTableName., must conform to the pattern /^[^.}{`]*$/.");
        }
