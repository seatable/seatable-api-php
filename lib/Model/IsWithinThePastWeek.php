...
/**
 * IsWithinThePastWeek Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinThePastWeek implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_the_past_week';
    ...
    public const FILTER_TERM_MODIFIER_THE_PAST_WEEK = 'the_past_week';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THE_PAST_WEEK,
        ];
    }
