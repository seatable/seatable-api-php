 ...
 */
class IsNotEmpty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_not_empty';
    ...
    public const FILTER_PREDICATE_IS_NOT_EMPTY = 'is_not_empty';
    ...
    {
        return [
            self::FILTER_PREDICATE_IS_NOT_EMPTY,
        ];
    }
