...
/**
 * NumberColumn Class Doc Comment
 *
 * @category Class
 ...
 */
class NumberColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'number_column';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling NumberColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
