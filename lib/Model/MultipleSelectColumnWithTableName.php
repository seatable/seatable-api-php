...
/**
 * MultipleSelectColumnWithTableName Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class MultipleSelectColumnWithTableName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'multiple_select_column_with_table_name';
    ...
    protected static $openAPITypes = [
        ...
        'column_data' => '\SeaTable\Client\Model\SelectColumnFormat'
    ];
    ...
    public const COLUMN_TYPE_MULTIPLE_SELECT = 'multiple-select';
    ...
    {
        return [
            self::COLUMN_TYPE_MULTIPLE_SELECT,
        ];
    }
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling MultipleSelectColumnWithTableName., must conform to the pattern /^[^.}{`]*$/.");
        }
     ...
     * Gets column_data
     *
     * @return \SeaTable\Client\Model\SelectColumnFormat|null
     */
     ...
     * Sets column_data
     *
     * @param \SeaTable\Client\Model\SelectColumnFormat|null $column_data column_data
     *
     * @return self
     */
