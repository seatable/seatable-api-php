 ...
 */
class Less implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'less';
    ...
    public const FILTER_PREDICATE_LESS = 'less';
