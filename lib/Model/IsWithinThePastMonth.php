...
/**
 * IsWithinThePastMonth Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinThePastMonth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_the_past_month';
    ...
    public const FILTER_TERM_MODIFIER_THE_PAST_MONTH = 'the_past_month';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THE_PAST_MONTH,
        ];
    }
