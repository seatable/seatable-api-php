...
/**
 * CreatorColumn Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatorColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'creator_column';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling CreatorColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
