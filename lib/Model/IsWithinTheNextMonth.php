...
/**
 * IsWithinTheNextMonth Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinTheNextMonth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_the_next_month';
    ...
    public const FILTER_PREDICATE_IS_WITHIN = 'is_within';
    public const FILTER_TERM_MODIFIER_THE_NEXT_MONTH = 'the_next_month';
    ...
    {
        return [
            self::FILTER_PREDICATE_IS_WITHIN,
        ];
    }
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THE_NEXT_MONTH,
        ];
    }
