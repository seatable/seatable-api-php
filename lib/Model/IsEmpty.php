 ...
 */
class IsEmpty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_empty';
    ...
    public const FILTER_PREDICATE_IS_EMPTY = 'is_empty';
    ...
    {
        return [
            self::FILTER_PREDICATE_IS_EMPTY,
        ];
    }
