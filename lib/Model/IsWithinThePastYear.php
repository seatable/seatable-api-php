...
/**
 * IsWithinThePastYear Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinThePastYear implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_the_past_year';
    ...
    public const FILTER_TERM_MODIFIER_THE_PAST_YEAR = 'the_past_year';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THE_PAST_YEAR,
        ];
    }
