...
/**
 * MultipleSelectColumn Class Doc Comment
 *
 * @category Class
 ...
 */
class MultipleSelectColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'multiple_select_column';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling MultipleSelectColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
