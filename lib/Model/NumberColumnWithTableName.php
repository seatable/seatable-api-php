...
/**
 * NumberColumnWithTableName Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class NumberColumnWithTableName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'number_column_with_table_name';
    ...
    protected static $openAPITypes = [
        ...
        'column_data' => '\SeaTable\Client\Model\NumberColumnFormat'
    ];
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling NumberColumnWithTableName., must conform to the pattern /^[^.}{`]*$/.");
        }
     ...
     * Gets column_data
     *
     * @return \SeaTable\Client\Model\NumberColumnFormat|null
     */
     ...
     * Sets column_data
     *
     * @param \SeaTable\Client\Model\NumberColumnFormat|null $column_data column_data
     *
     * @return self
     */
