...
/**
 * RatingColumn Class Doc Comment
 *
 * @category Class
 ...
 */
class RatingColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rating_column';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling RatingColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
