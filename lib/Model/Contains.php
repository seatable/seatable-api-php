 ...
 */
class Contains implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contains';
    ...
    public const FILTER_PREDICATE_CONTAINS = 'contains';
    ...
    {
        return [
            self::FILTER_PREDICATE_CONTAINS,
        ];
    }
