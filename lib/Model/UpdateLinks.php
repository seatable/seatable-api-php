 ...
 */
class UpdateLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_links';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('row_id_list', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['row_id_list'] === null) {
            $invalidProperties[] = "'row_id_list' can't be null";
        }
    ...
    public function setTableId($table_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{4}$/", ObjectSerializer::toString($table_id)))) {
            throw new \InvalidArgumentException("invalid value for \$table_id when calling UpdateLinks., must conform to the pattern /^[a-zA-Z0-9]{4}$/.");
        }
     ...
     * Sets other_table_id
     *
     * @param string $other_table_id The id of the table. The id of a table is unique inside a base and is often used to identify a table. **Important: the table_id is not the table_name**.
     *
     * @return self
     */
    public function setOtherTableId($other_table_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{4}$/", ObjectSerializer::toString($other_table_id)))) {
            throw new \InvalidArgumentException("invalid value for \$other_table_id when calling UpdateLinks., must conform to the pattern /^[a-zA-Z0-9]{4}$/.");
        }
    ...
    public function setLinkId($link_id)
    {
        ...
        if ((mb_strlen($link_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $link_id when calling UpdateLinks., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($link_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $link_id when calling UpdateLinks., must be bigger than or equal to 4.');
        }
    ...
    {
        return $this->container['row_id_list'];
    }

    /**
     * Sets row_id_list
     *
     * @param string[] $row_id_list List of the source rows IDs whose links you'd like to update.
     *
     * @return self
     */
    public function setRowIdList($row_id_list)
    {
        if (is_null($row_id_list)) {
            throw new \InvalidArgumentException('non-nullable row_id_list cannot be null');
        }
        $this->container['row_id_list'] = $row_id_list;
     ...
     *
     * @param string[] $other_rows_ids_map Map of IDs of the target rows which you'd like to link your source rows to.
     *
     * @return self
     */
