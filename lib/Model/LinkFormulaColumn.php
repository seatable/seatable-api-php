...
/**
 * LinkFormulaColumn Class Doc Comment
 *
 * @category Class
 ...
 */
class LinkFormulaColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'link_formula_column';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling LinkFormulaColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
