 ...
 */
class AppendRows implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'append_rows';
    ...
    */
     ...
     * Sets rows
     *
     * @param object[] $rows Defines the rows which should be added.
     *
     * @return self
     */
