...
/**
 * SingleSelectColumn Class Doc Comment
 *
 * @category Class
 ...
 */
class SingleSelectColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'single_select_column';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling SingleSelectColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
