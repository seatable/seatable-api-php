 ...
 */
class XxxToday implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'xxx_today';
    ...
    public const FILTER_TERM_MODIFIER_TODAY = 'today';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_TODAY,
        ];
    }
