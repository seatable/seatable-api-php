...
/**
 * DurationColumn Class Doc Comment
 *
 * @category Class
 ...
 */
class DurationColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'duration_column';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling DurationColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
