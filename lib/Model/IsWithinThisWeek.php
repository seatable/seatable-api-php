...
/**
 * IsWithinThisWeek Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinThisWeek implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_this_week';
    ...
    public const FILTER_TERM_MODIFIER_THIS_WEEK = 'this_week';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THIS_WEEK,
        ];
    }
