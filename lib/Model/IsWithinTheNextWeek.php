...
/**
 * IsWithinTheNextWeek Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinTheNextWeek implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_the_next_week';
    ...
    public const FILTER_TERM_MODIFIER_THE_NEXT_WEEK = 'the_next_week';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THE_NEXT_WEEK,
        ];
    }
