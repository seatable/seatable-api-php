<?php
/**
 * GetBaseTokenWithApiToken200Response
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetBaseTokenWithApiToken200Response Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetBaseTokenWithApiToken200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getBaseTokenWithApiToken_200_response';
    ...
    protected static $setters = [
        ...
        'use_api_gateway' => 'setUseApiGateway',
    ...
    protected static $getters = [
        ...
        'use_api_gateway' => 'getUseApiGateway',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('use_api_gateway', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets use_api_gateway
     *
     * @return bool|null
     */
    public function getUseApiGateway()
    {
        return $this->container['use_api_gateway'];
    }

    /**
     * Sets use_api_gateway
     *
     * @param bool|null $use_api_gateway use_api_gateway
     *
     * @return self
     */
    public function setUseApiGateway($use_api_gateway)
    {
        if (is_null($use_api_gateway)) {
            throw new \InvalidArgumentException('non-nullable use_api_gateway cannot be null');
        }
        $this->container['use_api_gateway'] = $use_api_gateway;
