...
class AccountTokenApi
{
    ...
    /**
     * Operation getAccountTokenfromUsername
     *
    ...
    {
        list($response) = $this->getAccountTokenfromUsernameWithHttpInfo($username, $password, $x_seafile_otp, $contentType);
        return $response;
    }

    /**
     * Operation getAccountTokenfromUsernameWithHttpInfo
     *
     * Get Account-Token with Username and Password
     *
     * @param  string $username Your email address (required)
    ...
    /**
     * Operation getAccountTokenfromUsernameAsync
     *
     * Get Account-Token with Username and Password
     *
     * @param  string $username Your email address (required)
     ...
     */
    public function getAccountTokenfromUsernameAsync($username, $password, $x_seafile_otp = null, string $contentType = self::contentTypes['getAccountTokenfromUsername'][0])
    {
        return $this->getAccountTokenfromUsernameAsyncWithHttpInfo($username, $password, $x_seafile_otp, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAccountTokenfromUsernameAsyncWithHttpInfo
     *
     * Get Account-Token with Username and Password
     *
     * @param  string $username Your email address (required)
    ...
    /**
     * Create request for operation 'getAccountTokenfromUsername'
     *
     * @param  string $username Your email address (required)
     * @param  string $password Your password (required)
     * @param  string $x_seafile_otp Two-factor token (usually generated with a mobile app like the google authenticator), optional, only needed if 2FA is activated for your account. (optional)
     ...
     */
    public function getAccountTokenfromUsernameRequest($username, $password, $x_seafile_otp = null, string $contentType = self::contentTypes['getAccountTokenfromUsername'][0])
    {

        // verify the required parameter 'username' is set
        if ($username === null || (is_array($username) && count($username) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $username when calling getAccountTokenfromUsername'
            );
        }
        ...
        if ($password === null || (is_array($password) && count($password) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $password when calling getAccountTokenfromUsername'
            );
        }

        if ($x_seafile_otp !== null && !preg_match("/^\\d{6}$/", $x_seafile_otp)) {
            throw new \InvalidArgumentException("invalid value for \"x_seafile_otp\" when calling AccountTokenApi.getAccountTokenfromUsername, must conform to the pattern /^\\d{6}$/.");
        }
        

        $resourcePath = '/api2/auth-token/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // header params
        if ($x_seafile_otp !== null) {
            $headerParams['X-SEAFILE-OTP'] = ObjectSerializer::toHeaderValue($x_seafile_otp);
        }
