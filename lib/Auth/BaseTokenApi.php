...
class BaseTokenApi
{
     ...
     *
     * @param  int $workspace_id The id of the workspace. For an explanation how to get the *workspace_id*, check out this [help-article](https://seatable.com/help/find-workspace-id-group/).  Alternatively the API endpoint [get metadata](/reference/getmetadata) can be used. (required)
     ...
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SeaTable\Client\Auth\GetBaseTokenWithApiToken200Response|object
     */
     ...
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SeaTable\Client\Auth\GetBaseTokenWithApiToken200Response|object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBaseTokenWithApiTokenWithHttpInfo($exp = '3d', string $contentType = self::contentTypes['getBaseTokenWithApiToken'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SeaTable\Client\Auth\GetBaseTokenWithApiToken200Response',
                        $request,
                        $response,
                    );
                case 403:
    ...
    {
        $returnType = '\SeaTable\Client\Auth\GetBaseTokenWithApiToken200Response';
        $request = $this->getBaseTokenWithApiTokenRequest($exp, $contentType);
