...
/**
 * GeolocationColumnWithTableName Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class GeolocationColumnWithTableName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'geolocation_column_with_table_name';
    ...
    protected static $openAPITypes = [
        ...
        'column_data' => '\SeaTable\Client\Base\GeoColumnFormat'
    ];
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling GeolocationColumnWithTableName., must conform to the pattern /^[^.}{`]*$/.");
        }
     ...
     * Gets column_data
     *
     * @return \SeaTable\Client\Base\GeoColumnFormat|null
     */
     ...
     * Sets column_data
     *
     * @param \SeaTable\Client\Base\GeoColumnFormat|null $column_data column_data
     *
     * @return self
     */
