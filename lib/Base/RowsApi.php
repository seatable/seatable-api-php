...
class RowsApi
{
     ...
     * @return object
     */
    public function deleteRow($base_uuid, $delete_rows = null, string $contentType = self::contentTypes['deleteRow'][0])
    {
        list($response) = $this->deleteRowWithHttpInfo($base_uuid, $delete_rows, $contentType);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteRowWithHttpInfo($base_uuid, $delete_rows = null, string $contentType = self::contentTypes['deleteRow'][0])
    {
        $request = $this->deleteRowRequest($base_uuid, $delete_rows, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteRowAsync($base_uuid, $delete_rows = null, string $contentType = self::contentTypes['deleteRow'][0])
    {
        return $this->deleteRowAsyncWithHttpInfo($base_uuid, $delete_rows, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteRowAsyncWithHttpInfo($base_uuid, $delete_rows = null, string $contentType = self::contentTypes['deleteRow'][0])
    {
        $returnType = 'object';
        $request = $this->deleteRowRequest($base_uuid, $delete_rows, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRowRequest($base_uuid, $delete_rows = null, string $contentType = self::contentTypes['deleteRow'][0])
    {
