...
/**
 * ResizeColumn Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResizeColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'resize_column';
    ...
    public const OP_TYPE_RESIZE_COLUMN = 'resize_column';
    ...
    */
    ...
    public function setColumn($column)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column)))) {
            throw new \InvalidArgumentException("invalid value for \$column when calling ResizeColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
