...
/**
 * SelectColumnFormatOptionsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class SelectColumnFormatOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'select_column_format_options_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id']) && !preg_match("/^([A-Za-z0-9]){6}$/", $this->container['id'])) {
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^([A-Za-z0-9]){6}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling SelectColumnFormatOptionsInner., must conform to the pattern /^([A-Za-z0-9]){6}$/.");
        }
     ...
     * Sets name
     *
     * @param string|null $name The name of your option.
     *
     * @return self
     */
     ...
     * Sets text_color
     *
     * @param string|null $text_color select your color-code for the text.
     *
     * @return self
     */
