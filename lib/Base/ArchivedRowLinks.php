...
/**
 * ArchivedRowLinks Class Doc Comment
 *
 * @category Class
 ...
 */
class ArchivedRowLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'archived_row_links';
    ...
    */
    ...
    public function setTableId($table_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{4}$/", ObjectSerializer::toString($table_id)))) {
            throw new \InvalidArgumentException("invalid value for \$table_id when calling ArchivedRowLinks., must conform to the pattern /^[a-zA-Z0-9]{4}$/.");
        }
    ...
    public function setOtherTableId($other_table_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{4}$/", ObjectSerializer::toString($other_table_id)))) {
            throw new \InvalidArgumentException("invalid value for \$other_table_id when calling ArchivedRowLinks., must conform to the pattern /^[a-zA-Z0-9]{4}$/.");
        }
    ...
    public function setLinkId($link_id)
    {
        ...
        if ((mb_strlen($link_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $link_id when calling ArchivedRowLinks., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($link_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $link_id when calling ArchivedRowLinks., must be bigger than or equal to 4.');
        }
     ...
     *
     * @param array<string,string[]> $other_rows_ids_map Map of IDs of the target rows which you'd like to link/unlink your source rows. Use a key-to-list like: ``` \"other_rows_ids_map\": {   \"<row1 of table>\": [\"<row1 of other_table>\", \"<row2 of other_table>\"],   \"<row2 of table>\": [\"<row3 of other_table>\"] } ```
     *
     * @return self
     */
