...
class FiltersFormula implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'column_key' => 'string',
        'filter_predicate' => '\SeaTable\Client\Base\StringFilterPredicate',
        'filter_term' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \SeaTable\Client\Base\StringFilterPredicate|null
     */
     ...
     *
     * @param \SeaTable\Client\Base\StringFilterPredicate|null $filter_predicate filter_predicate
     *
     * @return self
     */
