...
/**
 * UpdateRowsUpdatesInner Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateRowsUpdatesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_rows_updates_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['row_id']) && !preg_match("/^[a-zA-Z0-9\\-\\_]{22}$/", $this->container['row_id'])) {
    ...
    public function setRowId($row_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9\\-\\_]{22}$/", ObjectSerializer::toString($row_id)))) {
            throw new \InvalidArgumentException("invalid value for \$row_id when calling UpdateRowsUpdatesInner., must conform to the pattern /^[a-zA-Z0-9\\-\\_]{22}$/.");
        }
     ...
     * Sets row
     *
     * @param object|null $row Pass the set of column names and their values. The column names must be present in your table. Different column types require different ways to input values. For eg: {\"Name\":\"Max\", \"Age\":\"21\", \"Birthday\":\"2023-02-18\", \"Checkbox\":\"true\"}
     *
     * @return self
     */
