...
/**
 * DeleteSelectOptions Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeleteSelectOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'delete_select_options';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('option_names', $data ?? [], null);
    }
    ...
    */
    ...
    public function setColumn($column)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column)))) {
            throw new \InvalidArgumentException("invalid value for \$column when calling DeleteSelectOptions., must conform to the pattern /^[^.}{`]*$/.");
        }
     ...
     * Sets option_names
     *
     * @param string[] $option_names option_names
     *
     * @return self
     */
    public function setOptionNames($option_names)
    {
        if (is_null($option_names)) {
            throw new \InvalidArgumentException('non-nullable option_names cannot be null');
        }
