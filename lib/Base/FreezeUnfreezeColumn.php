...
/**
 * FreezeUnfreezeColumn Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class FreezeUnfreezeColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'freeze_unfreeze_column';
    ...
    */
    ...
    public function setColumn($column)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column)))) {
            throw new \InvalidArgumentException("invalid value for \$column when calling FreezeUnfreezeColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
