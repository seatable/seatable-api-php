...
/**
 * TableWithRowIds Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class TableWithRowIds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'table_with_row_ids';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['row_ids'] === null) {
            $invalidProperties[] = "'row_ids' can't be null";
        }
     ...
     * Sets row_ids
     *
     * @param string[] $row_ids ID of the rows to perform the requested operation.
     *
     * @return self
     */
