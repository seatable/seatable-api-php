...
class BigDataApi
{
     ...
     * @param  \SeaTable\Client\Base\InsertRowsIntoBigData|null $insert_rows_into_big_data insert_rows_into_big_data (optional)
     ...
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  \SeaTable\Client\Base\InsertRowsIntoBigData|null $insert_rows_into_big_data (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addBigDataRows'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation getBaseBigDataOperations
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getBaseBigDataOperations'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object
     */
    public function getBaseBigDataOperations($base_uuid, $page = null, $per_page = null, string $contentType = self::contentTypes['getBaseBigDataOperations'][0])
    {
        list($response) = $this->getBaseBigDataOperationsWithHttpInfo($base_uuid, $page, $per_page, $contentType);
        return $response;
    }

    /**
     * Operation getBaseBigDataOperationsWithHttpInfo
     *
     * Get Base Big Data Operations
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBaseBigDataOperationsWithHttpInfo($base_uuid, $page = null, $per_page = null, string $contentType = self::contentTypes['getBaseBigDataOperations'][0])
    {
        $request = $this->getBaseBigDataOperationsRequest($base_uuid, $page, $per_page, $contentType);
    ...
    /**
     * Operation getBaseBigDataOperationsAsync
     *
     * Get Base Big Data Operations
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBaseBigDataOperationsAsync($base_uuid, $page = null, $per_page = null, string $contentType = self::contentTypes['getBaseBigDataOperations'][0])
    {
        return $this->getBaseBigDataOperationsAsyncWithHttpInfo($base_uuid, $page, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBaseBigDataOperationsAsyncWithHttpInfo
     *
     * Get Base Big Data Operations
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBaseBigDataOperationsAsyncWithHttpInfo($base_uuid, $page = null, $per_page = null, string $contentType = self::contentTypes['getBaseBigDataOperations'][0])
    {
        $returnType = 'object';
        $request = $this->getBaseBigDataOperationsRequest($base_uuid, $page, $per_page, $contentType);
    ...
    /**
     * Create request for operation 'getBaseBigDataOperations'
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  int|null $page The page number you want to start showing the entries. If no value is provided, 1 will be used. (optional)
     * @param  int|null $per_page The number of results that should be returned. If no value is provided, 25 results will be returned. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBaseBigDataOperationsRequest($base_uuid, $page = null, $per_page = null, string $contentType = self::contentTypes['getBaseBigDataOperations'][0])
    {

        // verify the required parameter 'base_uuid' is set
        if ($base_uuid === null || (is_array($base_uuid) && count($base_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_uuid when calling getBaseBigDataOperations'
            );
        }
        if (!preg_match("/^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/", $base_uuid)) {
            throw new \InvalidArgumentException("invalid value for \"base_uuid\" when calling BigDataApi.getBaseBigDataOperations, must conform to the pattern /^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/.");
        }
        
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling BigDataApi.getBaseBigDataOperations, must be bigger than or equal to 1.');
        }
        
        if ($per_page !== null && $per_page < 1) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling BigDataApi.getBaseBigDataOperations, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/api-gateway/api/v2/dtables/{base_uuid}/db-operations/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  \SeaTable\Client\Base\ArchiveView|null $archive_view archive_view (optional)
     ...
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  \SeaTable\Client\Base\ArchiveView|null $archive_view (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['moveRowsToBigData'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  \SeaTable\Client\Base\MoveRowsToNormalBackendRequest|null $move_rows_to_normal_backend_request move_rows_to_normal_backend_request (optional)
     ...
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  \SeaTable\Client\Base\MoveRowsToNormalBackendRequest|null $move_rows_to_normal_backend_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['moveRowsToNormalBackend'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation restoreBigDataOperations
     *
     * Restore Big Data Operations
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  int $op_id The id of the big data operation logs. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['restoreBigDataOperations'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object
     */
    public function restoreBigDataOperations($base_uuid, $op_id, string $contentType = self::contentTypes['restoreBigDataOperations'][0])
    {
        list($response) = $this->restoreBigDataOperationsWithHttpInfo($base_uuid, $op_id, $contentType);
        return $response;
    }

    /**
     * Operation restoreBigDataOperationsWithHttpInfo
     *
     * Restore Big Data Operations
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function restoreBigDataOperationsWithHttpInfo($base_uuid, $op_id, string $contentType = self::contentTypes['restoreBigDataOperations'][0])
    {
        $request = $this->restoreBigDataOperationsRequest($base_uuid, $op_id, $contentType);
    ...
    /**
     * Operation restoreBigDataOperationsAsync
     *
     * Restore Big Data Operations
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restoreBigDataOperationsAsync($base_uuid, $op_id, string $contentType = self::contentTypes['restoreBigDataOperations'][0])
    {
        return $this->restoreBigDataOperationsAsyncWithHttpInfo($base_uuid, $op_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation restoreBigDataOperationsAsyncWithHttpInfo
     *
     * Restore Big Data Operations
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restoreBigDataOperationsAsyncWithHttpInfo($base_uuid, $op_id, string $contentType = self::contentTypes['restoreBigDataOperations'][0])
    {
        $returnType = 'object';
        $request = $this->restoreBigDataOperationsRequest($base_uuid, $op_id, $contentType);
    ...
    /**
     * Create request for operation 'restoreBigDataOperations'
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  int $op_id The id of the big data operation logs. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['restoreBigDataOperations'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function restoreBigDataOperationsRequest($base_uuid, $op_id, string $contentType = self::contentTypes['restoreBigDataOperations'][0])
    {

        // verify the required parameter 'base_uuid' is set
        if ($base_uuid === null || (is_array($base_uuid) && count($base_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_uuid when calling restoreBigDataOperations'
            );
        }
        if (!preg_match("/^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/", $base_uuid)) {
            throw new \InvalidArgumentException("invalid value for \"base_uuid\" when calling BigDataApi.restoreBigDataOperations, must conform to the pattern /^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'op_id' is set
        if ($op_id === null || (is_array($op_id) && count($op_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $op_id when calling restoreBigDataOperations'
            );
        }
        if ($op_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$op_id" when calling BigDataApi.restoreBigDataOperations, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/api-gateway/api/v2/dtables/{base_uuid}/restore-operations/{op_id}/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($op_id !== null) {
            $resourcePath = str_replace(
                '{' . 'op_id' . '}',
                ObjectSerializer::toPathValue($op_id),
                $resourcePath
            );
        }
