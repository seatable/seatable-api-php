 ...
 */
class MoveColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'move_column';
    ...
    public const OP_TYPE_MOVE_COLUMN = 'move_column';
    ...
    */
    ...
    public function setColumn($column)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column)))) {
            throw new \InvalidArgumentException("invalid value for \$column when calling MoveColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
