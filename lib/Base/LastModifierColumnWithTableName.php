...
/**
 * LastModifierColumnWithTableName Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class LastModifierColumnWithTableName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'last_modifier_column_with_table_name';
    ...
    public const COLUMN_TYPE_LAST_MODIFIER = 'last-modifier';
    ...
    {
        return [
            self::COLUMN_TYPE_LAST_MODIFIER,
        ];
    }
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling LastModifierColumnWithTableName., must conform to the pattern /^[^.}{`]*$/.");
        }
