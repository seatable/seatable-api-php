...
/**
 * MtimeColumnWithTableName Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class MtimeColumnWithTableName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mtime_column_with_table_name';
    ...
    public const COLUMN_TYPE_MTIME = 'mtime';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling MtimeColumnWithTableName., must conform to the pattern /^[^.}{`]*$/.");
        }
