...
/**
 * LinkFormulaColumnLookupFormat Class Doc Comment
 *
 * @category Class
 ...
 */
class LinkFormulaColumnLookupFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'link_formula_column_lookup_format';
    ...
    protected static $attributeMap = [
        ...
        'level2_linked_column' => 'level2_linked_column'
    ];
    ...
    protected static $setters = [
        ...
        'level2_linked_column' => 'setLevel2LinkedColumn'
    ];
    ...
    protected static $getters = [
        ...
        'level2_linked_column' => 'getLevel2LinkedColumn'
    ];
    ...
    public const FORMULA_LOOKUP = 'lookup';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('level2_linked_column', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets level2_linked_column
     *
     * @return string|null
     */
    public function getLevel2LinkedColumn()
    {
        return $this->container['level2_linked_column'];
    }

    /**
     * Sets level2_linked_column
     *
     * @param string|null $level2_linked_column Name of the column in the linked table linked by level1_linked_column to look up. The type of level1_linked_column should be 'link'.
     *
     * @return self
     */
    public function setLevel2LinkedColumn($level2_linked_column)
    {
        if (is_null($level2_linked_column)) {
            throw new \InvalidArgumentException('non-nullable level2_linked_column cannot be null');
        }
        $this->container['level2_linked_column'] = $level2_linked_column;
