...
class SqlQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'sql' => 'string',
        'convert_keys' => 'bool',
        'parameters' => '\SeaTable\Client\Base\SqlQueryParametersInner[]',
        'server_only' => 'bool'
    ];
    ...
    */
     ...
     * Sets convert_keys
     *
     * @param bool|null $convert_keys Determines if the columns are returned as their keys (false by default) or their names (true).
     *
     * @return self
     */
     ...
     * Gets parameters
     *
     * @return \SeaTable\Client\Base\SqlQueryParametersInner[]|null
     */
     ...
     * Sets parameters
     *
     * @param \SeaTable\Client\Base\SqlQueryParametersInner[]|null $parameters Parameters in SQL clause to avoid sql injection. Only needed, if you use `?` in the SQL statement. The parameters will replace the `?` according to their order in the array.
     *
     * @return self
     */
