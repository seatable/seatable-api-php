...
class ArchiveView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets where
     *
     * @param string|null $where Use an sql-like clause to select the rows you want to archive. If not set, all rows in the table will be archived.  More examples are: <br/> \\`Name\\` = 'Michael' <br/> \\`Gender\\` != 'Michael' <br/> \\`Name of the column\\` ilike '%error%'
     *
     * @return self
     */
