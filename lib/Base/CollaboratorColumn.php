...
/**
 * CollaboratorColumn Class Doc Comment
 *
 * @category Class
 ...
 */
class CollaboratorColumn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'collaborator_column';
    ...
    */
    ...
    public function setColumnName($column_name)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column_name)))) {
            throw new \InvalidArgumentException("invalid value for \$column_name when calling CollaboratorColumn., must conform to the pattern /^[^.}{`]*$/.");
        }
