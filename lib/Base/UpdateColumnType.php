...
/**
 * UpdateColumnType Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateColumnType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_column_type';
    ...
    public const OP_TYPE_MODIFY_COLUMN_TYPE = 'modify_column_type';
    ...
    {
        return [
            self::OP_TYPE_MODIFY_COLUMN_TYPE,
        ];
    }
    ...
    */
    ...
    public function setColumn($column)
    {
        ...
        if ((!preg_match("/^[^.}{`]*$/", ObjectSerializer::toString($column)))) {
            throw new \InvalidArgumentException("invalid value for \$column when calling UpdateColumnType., must conform to the pattern /^[^.}{`]*$/.");
        }
     ...
     * Sets column_data
     *
     * @param object|null $column_data column_data
     *
     * @return self
     */
