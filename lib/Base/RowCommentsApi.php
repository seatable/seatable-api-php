...
class RowCommentsApi
{
    ...
    /**
     * Operation createRowComment
     *
     * Create Row Comment
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  string $table_id The id of the table. The id of a table is unique inside a base and is often used to identify a table. (required)
     * @param  string $row_id Unique id of a row. (required)
     * @param  \SeaTable\Client\Base\CreateRowComment|null $create_row_comment create_row_comment (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createRowComment'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object
     */
    public function createRowComment($base_uuid, $table_id, $row_id, $create_row_comment = null, string $contentType = self::contentTypes['createRowComment'][0])
    {
        list($response) = $this->createRowCommentWithHttpInfo($base_uuid, $table_id, $row_id, $create_row_comment, $contentType);
        return $response;
    }

    /**
     * Operation createRowCommentWithHttpInfo
     *
     * Create Row Comment
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  string $table_id The id of the table. The id of a table is unique inside a base and is often used to identify a table. (required)
     * @param  string $row_id Unique id of a row. (required)
     * @param  \SeaTable\Client\Base\CreateRowComment|null $create_row_comment (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createRowComment'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function createRowCommentWithHttpInfo($base_uuid, $table_id, $row_id, $create_row_comment = null, string $contentType = self::contentTypes['createRowComment'][0])
    {
        $request = $this->createRowCommentRequest($base_uuid, $table_id, $row_id, $create_row_comment, $contentType);
    ...
    /**
     * Operation createRowCommentAsync
     *
     * Create Row Comment
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     */
    public function createRowCommentAsync($base_uuid, $table_id, $row_id, $create_row_comment = null, string $contentType = self::contentTypes['createRowComment'][0])
    {
        return $this->createRowCommentAsyncWithHttpInfo($base_uuid, $table_id, $row_id, $create_row_comment, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createRowCommentAsyncWithHttpInfo
     *
     * Create Row Comment
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRowCommentAsyncWithHttpInfo($base_uuid, $table_id, $row_id, $create_row_comment = null, string $contentType = self::contentTypes['createRowComment'][0])
    {
        $returnType = 'object';
        $request = $this->createRowCommentRequest($base_uuid, $table_id, $row_id, $create_row_comment, $contentType);
    ...
    /**
     * Create request for operation 'createRowComment'
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  string $table_id The id of the table. The id of a table is unique inside a base and is often used to identify a table. (required)
     * @param  string $row_id Unique id of a row. (required)
     ...
     */
    public function createRowCommentRequest($base_uuid, $table_id, $row_id, $create_row_comment = null, string $contentType = self::contentTypes['createRowComment'][0])
    {

        // verify the required parameter 'base_uuid' is set
        if ($base_uuid === null || (is_array($base_uuid) && count($base_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_uuid when calling createRowComment'
            );
        }
        if (!preg_match("/^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/", $base_uuid)) {
            throw new \InvalidArgumentException("invalid value for \"base_uuid\" when calling RowCommentsApi.createRowComment, must conform to the pattern /^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/.");
        }
        
        // verify the required parameter 'table_id' is set
        if ($table_id === null || (is_array($table_id) && count($table_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $table_id when calling createRowComment'
            );
        }
        if (!preg_match("/^[A-Za-z0-9]{4}$/", $table_id)) {
            throw new \InvalidArgumentException("invalid value for \"table_id\" when calling RowCommentsApi.createRowComment, must conform to the pattern /^[A-Za-z0-9]{4}$/.");
        }
        
        // verify the required parameter 'row_id' is set
        if ($row_id === null || (is_array($row_id) && count($row_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $row_id when calling createRowComment'
            );
        }
        if (!preg_match("/^[A-Za-z0-9\\-\\_]{22}$/", $row_id)) {
            throw new \InvalidArgumentException("invalid value for \"row_id\" when calling RowCommentsApi.createRowComment, must conform to the pattern /^[A-Za-z0-9\\-\\_]{22}$/.");
        }
        ...
        // for model (json/xml)
        if (isset($create_row_comment)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_row_comment));
            } else {
                $httpBody = $create_row_comment;
            }
    ...
    {
        $returnType = '\SeaTable\Client\Base\GetComment200Response';
        $request = $this->getCommentRequest($base_uuid, $comment_id, $contentType);
    ...
    /**
     * Operation getNumberOfComments
     *
     * Get Number of Comments
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getNumberOfComments'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object
     */
    public function getNumberOfComments($base_uuid, string $contentType = self::contentTypes['getNumberOfComments'][0])
    {
        list($response) = $this->getNumberOfCommentsWithHttpInfo($base_uuid, $contentType);
        return $response;
    }

    /**
     * Operation getNumberOfCommentsWithHttpInfo
     *
     * Get Number of Comments
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getNumberOfCommentsWithHttpInfo($base_uuid, string $contentType = self::contentTypes['getNumberOfComments'][0])
    {
        $request = $this->getNumberOfCommentsRequest($base_uuid, $contentType);
    ...
    /**
     * Operation getNumberOfCommentsAsync
     *
     * Get Number of Comments
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getNumberOfCommentsAsync($base_uuid, string $contentType = self::contentTypes['getNumberOfComments'][0])
    {
        return $this->getNumberOfCommentsAsyncWithHttpInfo($base_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getNumberOfCommentsAsyncWithHttpInfo
     *
     * Get Number of Comments
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getNumberOfCommentsAsyncWithHttpInfo($base_uuid, string $contentType = self::contentTypes['getNumberOfComments'][0])
    {
        $returnType = 'object';
        $request = $this->getNumberOfCommentsRequest($base_uuid, $contentType);
    ...
    /**
     * Create request for operation 'getNumberOfComments'
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getNumberOfComments'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getNumberOfCommentsRequest($base_uuid, string $contentType = self::contentTypes['getNumberOfComments'][0])
    {

        // verify the required parameter 'base_uuid' is set
        if ($base_uuid === null || (is_array($base_uuid) && count($base_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_uuid when calling getNumberOfComments'
            );
        }
        if (!preg_match("/^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/", $base_uuid)) {
            throw new \InvalidArgumentException("invalid value for \"base_uuid\" when calling RowCommentsApi.getNumberOfComments, must conform to the pattern /^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/.");
        }
        

        $resourcePath = '/api/v2.1/dtables/{base_uuid}/rows-comments-num/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  int|null $days Number of days to look back for comments. (optional)
