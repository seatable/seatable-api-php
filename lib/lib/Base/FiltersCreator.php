...
class FiltersCreator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'column_key' => 'string',
        'filter_predicate' => '\SeaTable\Client\Base\CreatorFilterPredicate',
        'filter_term' => 'string[]'
    ];
    ...
    */
     ...
     *
     * @return \SeaTable\Client\Base\CreatorFilterPredicate|null
     */
     ...
     *
     * @param \SeaTable\Client\Base\CreatorFilterPredicate|null $filter_predicate filter_predicate
     *
     * @return self
     */
