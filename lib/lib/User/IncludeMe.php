 ...
 */
class IncludeMe implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'include_me';
    ...
    public const FILTER_PREDICATE_INCLUDE_ME = 'include_me';
    ...
    {
        return [
            self::FILTER_PREDICATE_INCLUDE_ME,
        ];
    }
