...
/**
 * IsWithinThePastNumberOfDays Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinThePastNumberOfDays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_the_past_number_of_days';
    ...
    public const FILTER_TERM_MODIFIER_THE_PAST_NUMBER_OF_DAYS = 'the_past_number_of_days';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THE_PAST_NUMBER_OF_DAYS,
        ];
    }
