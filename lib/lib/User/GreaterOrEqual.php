...
/**
 * GreaterOrEqual Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class GreaterOrEqual implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'greater_or_equal';
    ...
    public const FILTER_PREDICATE_GREATER_OR_EQUAL = 'greater_or_equal';
    ...
    {
        return [
            self::FILTER_PREDICATE_GREATER_OR_EQUAL,
        ];
    }
