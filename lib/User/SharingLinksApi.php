...
class SharingLinksApi
{
     ...
     * @param  int|null $expire_days Add expiration period in days. Optional. (optional)
     * @param  string|null $token An optional custom token of the generated link. For example, it&#39;ll appear as \\\&quot;https&lt;span&gt;://cloud.seatable.io/dtable/view-external-links/custom/example/\\\&quot;. If not given, SeaTable will give a random token to the link. (optional)
    ...
    public function listViewExternalLinksRequest($table_id, $view_id, $workspace_id, $base_name, string $contentType = self::contentTypes['listViewExternalLinks'][0])
    {
        ...
        if (!preg_match("/^[A-Za-z0-9]{4}$/", $view_id)) {
            throw new \InvalidArgumentException("invalid value for \"view_id\" when calling SharingLinksApi.listViewExternalLinks, must conform to the pattern /^[A-Za-z0-9]{4}$/.");
        }
