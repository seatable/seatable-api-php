 ...
 */
class LessOrEqual implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'less_or_equal';
    ...
    public const FILTER_PREDICATE_LESS_OR_EQUAL = 'less_or_equal';
    ...
    {
        return [
            self::FILTER_PREDICATE_LESS_OR_EQUAL,
        ];
    }
