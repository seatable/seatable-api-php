 ...
 */
class IsNoneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_none_of';
    ...
    public const FILTER_PREDICATE_IS_NONE_OF = 'is_none_of';
    ...
    {
        return [
            self::FILTER_PREDICATE_IS_NONE_OF,
        ];
    }
