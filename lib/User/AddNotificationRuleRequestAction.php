<?php
/**
 * AddNotificationRuleRequestAction
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AddNotificationRuleRequestAction Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddNotificationRuleRequestAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addNotificationRule_request_action';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Currently only 'notify' for internal notification supported.
     *
     * @return self
     */
     ...
     * Sets users
     *
     * @param string[]|null $users List of user IDs to notify.
     *
     * @return self
     */
     ...
     *
     * @param string|null $users_column_key Column key with collaborators to notify.
     *
     * @return self
     */
     ...
     * Sets default_msg
     *
     * @param string|null $default_msg Optional message to notify users.
     *
     * @return self
     */
