...
class ImportExportApi
{
    ...
    public function exportBigDataViewRequest($workspace_id, $base_name, $table_id, $view_id, string $contentType = self::contentTypes['exportBigDataView'][0])
    {
        ...
        if (!preg_match("/^[A-Za-z0-9]{4}$/", $view_id)) {
            throw new \InvalidArgumentException("invalid value for \"view_id\" when calling ImportExportApi.exportBigDataView, must conform to the pattern /^[A-Za-z0-9]{4}$/.");
        }
    ...
    public function exportViewRequest($table_id, $table_name, $dtable_name, $view_id, $view_name, $workspace_id, string $contentType = self::contentTypes['exportView'][0])
    {
        ...
        if (!preg_match("/^[A-Za-z0-9]{4}$/", $view_id)) {
            throw new \InvalidArgumentException("invalid value for \"view_id\" when calling ImportExportApi.exportView, must conform to the pattern /^[A-Za-z0-9]{4}$/.");
        }
     ...
     * @param  string $dtable_uuid The UUID of the base. (required)
     * @param  string $table_name The name of the table. (required)
     * @param  string $selected_columns A list of column names used to determine which rows in the table should be updated or added as new. Separate multiple column names with commas (,). (required)
     ...
     * @return object
     */
    public function updateFromFile($workspace_id, $file, $dtable_uuid, $table_name, $selected_columns, string $contentType = self::contentTypes['updateFromFile'][0])
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateFromFileWithHttpInfo($workspace_id, $file, $dtable_uuid, $table_name, $selected_columns, string $contentType = self::contentTypes['updateFromFile'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFromFileAsync($workspace_id, $file, $dtable_uuid, $table_name, $selected_columns, string $contentType = self::contentTypes['updateFromFile'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFromFileAsyncWithHttpInfo($workspace_id, $file, $dtable_uuid, $table_name, $selected_columns, string $contentType = self::contentTypes['updateFromFile'][0])
    {
        $returnType = 'object';
        $request = $this->updateFromFileRequest($workspace_id, $file, $dtable_uuid, $table_name, $selected_columns, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateFromFileRequest($workspace_id, $file, $dtable_uuid, $table_name, $selected_columns, string $contentType = self::contentTypes['updateFromFile'][0])
    {
        ...
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling updateFromFile'
            );
        }
        ...
        if ($dtable_uuid === null || (is_array($dtable_uuid) && count($dtable_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $dtable_uuid when calling updateFromFile'
            );
        }
        ...
        if ($table_name === null || (is_array($table_name) && count($table_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $table_name when calling updateFromFile'
            );
        }

        // verify the required parameter 'selected_columns' is set
        if ($selected_columns === null || (is_array($selected_columns) && count($selected_columns) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $selected_columns when calling updateFromFile'
            );
        }
