 ...
 */
class NotEqual implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'not_equal';
    ...
    public const FILTER_PREDICATE_NOT_EQUAL = 'not_equal';
    ...
    {
        return [
            self::FILTER_PREDICATE_NOT_EQUAL,
        ];
    }
