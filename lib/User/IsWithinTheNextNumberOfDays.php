...
/**
 * IsWithinTheNextNumberOfDays Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class IsWithinTheNextNumberOfDays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_within_the_next_number_of_days';
    ...
    public const FILTER_TERM_MODIFIER_THE_NEXT_NUMBER_OF_DAYS = 'the_next_number_of_days';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_THE_NEXT_NUMBER_OF_DAYS,
        ];
    }
