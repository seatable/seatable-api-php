 ...
 */
class Greater implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'greater';
    ...
    public const FILTER_PREDICATE_GREATER = 'greater';
