 ...
 */
class BaseTable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Base_table';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string|null $uuid The UUID of the base.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the base.
     *
     * @return self
     */
