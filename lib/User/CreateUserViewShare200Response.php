<?php
/**
 * CreateUserViewShare200Response
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateUserViewShare200Response Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateUserViewShare200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createUserViewShare_200_response';
    ...
    */
     ...
     * Sets to_user_name
     *
     * @param string|null $to_user_name to_user_name
     *
     * @return self
     */
    public function setToUserName($to_user_name)
    {
        if (is_null($to_user_name)) {
            throw new \InvalidArgumentException('non-nullable to_user_name cannot be null');
        }
    ...
    {
        return $this->container['shared_name'];
    }

    /**
     * Sets shared_name
     *
     * @param string|null $shared_name shared_name
     *
     * @return self
     */
    public function setSharedName($shared_name)
    {
        if (is_null($shared_name)) {
            throw new \InvalidArgumentException('non-nullable shared_name cannot be null');
        }
        $this->container['shared_name'] = $shared_name;
