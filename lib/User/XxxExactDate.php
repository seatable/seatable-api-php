...
/**
 * XxxExactDate Class Doc Comment
 *
 * @category Class
 ...
 */
class XxxExactDate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'xxx_exact_date';
    ...
    public const FILTER_TERM_MODIFIER_EXACT_DATE = 'exact_date';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_EXACT_DATE,
        ];
    }
    ...
    */
    ...
    public function setFilterTerm($filter_term)
    {
        ...
        if ((!preg_match("/^[0-9]{4}-((0[1-9])|(1[0-2]))?-(([0-2][0-9])|(3[01]))?$/", ObjectSerializer::toString($filter_term)))) {
            throw new \InvalidArgumentException("invalid value for \$filter_term when calling XxxExactDate., must conform to the pattern /^[0-9]{4}-((0[1-9])|(1[0-2]))?-(([0-2][0-9])|(3[01]))?$/.");
        }
