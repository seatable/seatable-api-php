...
/**
 * XxxNumberOfDaysFromNow Class Doc Comment
 *
 * @category Class
 ...
 */
class XxxNumberOfDaysFromNow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'xxx_number_of_days_from_now';
    ...
    public const FILTER_TERM_MODIFIER_NUMBER_OF_DAYS_FROM_NOW = 'number_of_days_from_now';
    ...
    {
        return [
            self::FILTER_TERM_MODIFIER_NUMBER_OF_DAYS_FROM_NOW,
        ];
    }
    ...
    */
     ...
     * Sets filter_term
     *
     * @param int|null $filter_term filter_term
     *
     * @return self
     */
