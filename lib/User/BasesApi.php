...
class BasesApi
{
     ...
     * @param  \SeaTable\Client\User\BasePasswordRequest|null $base_password_request base_password_request (optional)
     ...
     * @param  int $workspace_id id of your workspace. (required)
     * @param  string $base_name name of your base. (required)
     * @param  \SeaTable\Client\User\BasePasswordRequest|null $base_password_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['basePassword'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $icon The icon of the base. Optional. Refer to [\\\&quot;Create A Base\\\&quot;](/reference/createbase) for the list of available icons. (optional)
     * @param  string|null $color The icon color of the base. Optional. Refer to [\\\&quot;Create A Base\\\&quot;](/reference/createbase) for the list of available icon colors. (optional)
    ...
    /**
     * Operation getBaseSize
     *
     * Get Base Size
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getBaseSize'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object
     */
    public function getBaseSize($base_uuid, string $contentType = self::contentTypes['getBaseSize'][0])
    {
        list($response) = $this->getBaseSizeWithHttpInfo($base_uuid, $contentType);
        return $response;
    }

    /**
     * Operation getBaseSizeWithHttpInfo
     *
     * Get Base Size
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBaseSizeWithHttpInfo($base_uuid, string $contentType = self::contentTypes['getBaseSize'][0])
    {
        $request = $this->getBaseSizeRequest($base_uuid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBaseSizeAsync($base_uuid, string $contentType = self::contentTypes['getBaseSize'][0])
    {
        return $this->getBaseSizeAsyncWithHttpInfo($base_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBaseSizeAsyncWithHttpInfo
     *
     * Get Base Size
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBaseSizeAsyncWithHttpInfo($base_uuid, string $contentType = self::contentTypes['getBaseSize'][0])
    {
        $returnType = 'object';
        $request = $this->getBaseSizeRequest($base_uuid, $contentType);
    ...
    /**
     * Create request for operation 'getBaseSize'
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getBaseSize'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBaseSizeRequest($base_uuid, string $contentType = self::contentTypes['getBaseSize'][0])
    {

        // verify the required parameter 'base_uuid' is set
        if ($base_uuid === null || (is_array($base_uuid) && count($base_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_uuid when calling getBaseSize'
            );
        }
        if (!preg_match("/^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/", $base_uuid)) {
            throw new \InvalidArgumentException("invalid value for \"base_uuid\" when calling BasesApi.getBaseSize, must conform to the pattern /^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/.");
        }
        

        $resourcePath = '/api/v2.1/dtable/{base_uuid}/size/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * List Favorites
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listFavorites'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object
     */
    public function listFavorites(string $contentType = self::contentTypes['listFavorites'][0])
    {
        list($response) = $this->listFavoritesWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function listFavoritesWithHttpInfo(string $contentType = self::contentTypes['listFavorites'][0])
    {
        $request = $this->listFavoritesRequest($contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listFavoritesAsync(string $contentType = self::contentTypes['listFavorites'][0])
    {
        return $this->listFavoritesAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listFavoritesAsyncWithHttpInfo
     *
     * List Favorites
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listFavorites'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listFavoritesAsyncWithHttpInfo(string $contentType = self::contentTypes['listFavorites'][0])
    {
        $returnType = 'object';
        $request = $this->listFavoritesRequest($contentType);
    ...
    /**
     * Create request for operation 'listFavorites'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listFavorites'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listFavoritesRequest(string $contentType = self::contentTypes['listFavorites'][0])
    {
     ...
     *
     * @param  int $workspace_id id of your workspace. (required)
     * @param  string|null $item_type Required. (optional)
     * @param  string|null $item_id When moving a base, use its &#x60;UUID&#x60;. Required. (optional)
     * @param  string|null $from From which folder are you moving the base out of? If from the root, use &#39;/&#39;. Otherwise use a &#x60;folder_id&#x60;. Required. (optional)
     * @param  string|null $to The ID of the target folder. Required. (optional)
     ...
     *
     * @param  int $workspace_id id of your workspace. (required)
     * @param  string|null $name The old name of the base. Required. (optional)
     * @param  string|null $new_name The new name of the base. Optional. (optional)
     * @param  string|null $icon The icon of the base. Optional. Refer to [\\\&quot;Create A Base\\\&quot;](/reference/createbase) for the list of available icons. (optional)
     * @param  string|null $color The icon color of the base. Optional. Refer to [\\\&quot;Create A Base\\\&quot;](/reference/createbase) for the list of available icon colors. (optional)
