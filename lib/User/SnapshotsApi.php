...
class SnapshotsApi
{
     ...
     * @return object
     */
    public function getBigDataStatus($workspace_id, $base_name, string $contentType = self::contentTypes['getBigDataStatus'][0])
    {
        list($response) = $this->getBigDataStatusWithHttpInfo($workspace_id, $base_name, $contentType);
        return $response;
    }
     ...
     */
    public function getBigDataStatusWithHttpInfo($workspace_id, $base_name, string $contentType = self::contentTypes['getBigDataStatus'][0])
    {
        $request = $this->getBigDataStatusRequest($workspace_id, $base_name, $contentType);
     ...
     */
    public function getBigDataStatusAsync($workspace_id, $base_name, string $contentType = self::contentTypes['getBigDataStatus'][0])
    {
        return $this->getBigDataStatusAsyncWithHttpInfo($workspace_id, $base_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBigDataStatusAsyncWithHttpInfo($workspace_id, $base_name, string $contentType = self::contentTypes['getBigDataStatus'][0])
    {
        $returnType = 'object';
        $request = $this->getBigDataStatusRequest($workspace_id, $base_name, $contentType);
     ...
     */
    public function getBigDataStatusRequest($workspace_id, $base_name, string $contentType = self::contentTypes['getBigDataStatus'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling getBigDataStatus'
            );
        }
        if ($workspace_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$workspace_id" when calling SnapshotsApi.getBigDataStatus, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'base_name' is set
        if ($base_name === null || (is_array($base_name) && count($base_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_name when calling getBigDataStatus'
            );
        }


        $resourcePath = '/api/v2.1/workspace/{workspace_id}/dtable/{base_name}/big-data-state/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation listBigDataBackups
     *
     * List Big Data Backups
     *
     * @param  int $workspace_id id of your workspace. (required)
     * @param  string $base_name name of your base. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listBigDataBackups'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object
     */
    public function listBigDataBackups($workspace_id, $base_name, string $contentType = self::contentTypes['listBigDataBackups'][0])
    {
        list($response) = $this->listBigDataBackupsWithHttpInfo($workspace_id, $base_name, $contentType);
        return $response;
    }

    /**
     * Operation listBigDataBackupsWithHttpInfo
     *
     * List Big Data Backups
     *
     * @param  int $workspace_id id of your workspace. (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function listBigDataBackupsWithHttpInfo($workspace_id, $base_name, string $contentType = self::contentTypes['listBigDataBackups'][0])
    {
        $request = $this->listBigDataBackupsRequest($workspace_id, $base_name, $contentType);
    ...
    /**
     * Operation listBigDataBackupsAsync
     *
     * List Big Data Backups
     *
     * @param  int $workspace_id id of your workspace. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listBigDataBackupsAsync($workspace_id, $base_name, string $contentType = self::contentTypes['listBigDataBackups'][0])
    {
        return $this->listBigDataBackupsAsyncWithHttpInfo($workspace_id, $base_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listBigDataBackupsAsyncWithHttpInfo
     *
     * List Big Data Backups
     *
     * @param  int $workspace_id id of your workspace. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listBigDataBackupsAsyncWithHttpInfo($workspace_id, $base_name, string $contentType = self::contentTypes['listBigDataBackups'][0])
    {
        $returnType = 'object';
        $request = $this->listBigDataBackupsRequest($workspace_id, $base_name, $contentType);
    ...
    /**
     * Create request for operation 'listBigDataBackups'
     *
     * @param  int $workspace_id id of your workspace. (required)
     * @param  string $base_name name of your base. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listBigDataBackups'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listBigDataBackupsRequest($workspace_id, $base_name, string $contentType = self::contentTypes['listBigDataBackups'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling listBigDataBackups'
            );
        }
        if ($workspace_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$workspace_id" when calling SnapshotsApi.listBigDataBackups, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'base_name' is set
        if ($base_name === null || (is_array($base_name) && count($base_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_name when calling listBigDataBackups'
            );
        }


        $resourcePath = '/api/v2.1/workspace/{workspace_id}/dtable/{base_name}/archive-backups/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
