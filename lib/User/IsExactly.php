 ...
 */
class IsExactly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_exactly';
    ...
    public const FILTER_PREDICATE_IS_EXACTLY = 'is_exactly';
    ...
    {
        return [
            self::FILTER_PREDICATE_IS_EXACTLY,
        ];
    }
