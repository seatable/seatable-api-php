 ...
 */
class HasNoneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'has_none_of';
    ...
    public const FILTER_PREDICATE_HAS_NONE_OF = 'has_none_of';
    ...
    {
        return [
            self::FILTER_PREDICATE_HAS_NONE_OF,
        ];
    }
