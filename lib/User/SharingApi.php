...
class SharingApi
{
    ...
    public function deleteGroupAllViewShareRequest($table_id, $view_id, $workspace_id, $base_name, string $contentType = self::contentTypes['deleteGroupAllViewShare'][0])
    {
        ...
        if (!preg_match("/^[A-Za-z0-9]{4}$/", $view_id)) {
            throw new \InvalidArgumentException("invalid value for \"view_id\" when calling SharingApi.deleteGroupAllViewShare, must conform to the pattern /^[A-Za-z0-9]{4}$/.");
        }
    ...
    public function deleteUserAllViewShareRequest($table_id, $view_id, $workspace_id, $base_name, string $contentType = self::contentTypes['deleteUserAllViewShare'][0])
    {
        ...
        if (!preg_match("/^[A-Za-z0-9]{4}$/", $view_id)) {
            throw new \InvalidArgumentException("invalid value for \"view_id\" when calling SharingApi.deleteUserAllViewShare, must conform to the pattern /^[A-Za-z0-9]{4}$/.");
        }
