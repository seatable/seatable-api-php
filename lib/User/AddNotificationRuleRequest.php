...
/**
 * AddNotificationRuleRequest Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddNotificationRuleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addNotificationRule_request';
    ...
    protected static $openAPITypes = [
        ...
        'trigger' => '\SeaTable\Client\User\AddNotificationRuleRequestTrigger',
        'action' => '\SeaTable\Client\User\AddNotificationRuleRequestAction'
    ];
    ...
    public const RUN_CONDITION_PER_DAY = 'per_day';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['run_condition'] === null) {
            $invalidProperties[] = "'run_condition' can't be null";
        }
     ...
     * Sets run_condition
     *
     * @param string $run_condition Defines whether the action is triggered by date or table update. For \"Records near deadline\" use \"per_day\". For \"Records modified\" and \"Records meet specific conditions after modification\" use \"per_update\".
     *
     * @return self
     */
     ...
     * Gets trigger
     *
     * @return \SeaTable\Client\User\AddNotificationRuleRequestTrigger
     */
     ...
     * Sets trigger
     *
     * @param \SeaTable\Client\User\AddNotificationRuleRequestTrigger $trigger trigger
     *
     * @return self
     */
     ...
     * Gets action
     *
     * @return \SeaTable\Client\User\AddNotificationRuleRequestAction
     */
     ...
     * Sets action
     *
     * @param \SeaTable\Client\User\AddNotificationRuleRequestAction $action action
     *
     * @return self
     */
