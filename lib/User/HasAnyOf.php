 ...
 */
class HasAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'has_any_of';
    ...
    public const FILTER_PREDICATE_HAS_ANY_OF = 'has_any_of';
    ...
    {
        return [
            self::FILTER_PREDICATE_HAS_ANY_OF,
        ];
    }
