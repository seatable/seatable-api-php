...
/**
 * BasePasswordRequest Class Doc Comment
 *
 * @category Class
 * @package  SeaTable\Client
 * @author   OpenAPI Generator team
 ...
 */
class BasePasswordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'basePassword_request';
    ...
    public const OPERATION_PASSWORD_UNSET = 'password_unset';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name of the Base
     *
     * @return self
     */
