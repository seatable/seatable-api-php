 ...
 */
class Equal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'equal';
    ...
    public const FILTER_PREDICATE_EQUAL = 'equal';
