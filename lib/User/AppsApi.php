...
class AppsApi
{
    ...
    public const contentTypes = [
        'apiV21UniversalAppsAppTokenAppUsersGet' => [
            'application/json',
        ],
        'changeAppStatus' => [
            'application/json',
    ...
    /**
     * Operation apiV21UniversalAppsAppTokenAppUsersGet
     *
     * List Universal App Users
     *
     * @param  string $app_token app_token (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV21UniversalAppsAppTokenAppUsersGet'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function apiV21UniversalAppsAppTokenAppUsersGet($app_token, string $contentType = self::contentTypes['apiV21UniversalAppsAppTokenAppUsersGet'][0])
    {
        $this->apiV21UniversalAppsAppTokenAppUsersGetWithHttpInfo($app_token, $contentType);
    }

    /**
     * Operation apiV21UniversalAppsAppTokenAppUsersGetWithHttpInfo
     *
     * List Universal App Users
     *
     ...
     */
    public function apiV21UniversalAppsAppTokenAppUsersGetWithHttpInfo($app_token, string $contentType = self::contentTypes['apiV21UniversalAppsAppTokenAppUsersGet'][0])
    {
        $request = $this->apiV21UniversalAppsAppTokenAppUsersGetRequest($app_token, $contentType);
    ...
    /**
     * Operation apiV21UniversalAppsAppTokenAppUsersGetAsync
     *
     * List Universal App Users
     *
     * @param  string $app_token (required)
     ...
     */
    public function apiV21UniversalAppsAppTokenAppUsersGetAsync($app_token, string $contentType = self::contentTypes['apiV21UniversalAppsAppTokenAppUsersGet'][0])
    {
        return $this->apiV21UniversalAppsAppTokenAppUsersGetAsyncWithHttpInfo($app_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV21UniversalAppsAppTokenAppUsersGetAsyncWithHttpInfo
     *
     * List Universal App Users
     *
     * @param  string $app_token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV21UniversalAppsAppTokenAppUsersGetAsyncWithHttpInfo($app_token, string $contentType = self::contentTypes['apiV21UniversalAppsAppTokenAppUsersGet'][0])
    {
        $returnType = '';
        $request = $this->apiV21UniversalAppsAppTokenAppUsersGetRequest($app_token, $contentType);
    ...
    /**
     * Create request for operation 'apiV21UniversalAppsAppTokenAppUsersGet'
     *
     * @param  string $app_token (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV21UniversalAppsAppTokenAppUsersGet'] to see the possible values for this operation
     *
     ...
     */
    public function apiV21UniversalAppsAppTokenAppUsersGetRequest($app_token, string $contentType = self::contentTypes['apiV21UniversalAppsAppTokenAppUsersGet'][0])
    {

        // verify the required parameter 'app_token' is set
        if ($app_token === null || (is_array($app_token) && count($app_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_token when calling apiV21UniversalAppsAppTokenAppUsersGet'
            );
        }
        if (!preg_match("/^[0-9a-f]{8}-([a-f1-9]{4}-){3}[a-f0-9]{12}$/", $app_token)) {
            throw new \InvalidArgumentException("invalid value for \"app_token\" when calling AppsApi.apiV21UniversalAppsAppTokenAppUsersGet, must conform to the pattern /^[0-9a-f]{8}-([a-f1-9]{4}-){3}[a-f0-9]{12}$/.");
        }
     ...
     *
     * @param  string $app_token app_token (required)
     * @param  \SeaTable\Client\Model\IsInactive $is_inactive is_inactive (optional)
     ...
     *
     * @param  string $app_token (required)
     * @param  \SeaTable\Client\Model\IsInactive $is_inactive (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['changeAppStatus'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $app_token app_token (required)
     * @param  \SeaTable\Client\Model\ImportUsersToAppRequest $import_users_to_app_request import_users_to_app_request (optional)
     ...
     *
     * @param  string $app_token (required)
     * @param  \SeaTable\Client\Model\ImportUsersToAppRequest $import_users_to_app_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['importUsersToApp'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
