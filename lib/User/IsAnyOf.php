 ...
 */
class IsAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'is_any_of';
    ...
    public const FILTER_PREDICATE_IS_ANY_OF = 'is_any_of';
    ...
    {
        return [
            self::FILTER_PREDICATE_IS_ANY_OF,
        ];
    }
