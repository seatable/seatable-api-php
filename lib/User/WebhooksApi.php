...
class WebhooksApi
{
     ...
     * @param  string|null $url The URL of the webhook. It should start with &#x60;http(s)&#x60;. Required. (optional)
     * @param  int|null $secret When you set a secret, you&#39;ll receive the X-SeaTable-Signature header, whose value is the result of SHA1 encryption of the secret key, in the webhook POST request. Optional. (optional)
     ...
     * @param  int $workspace_id id of your workspace. (required)
     * @param  string $base_name name of your base. (required)
     * @param  int $webhook_id The ID of the webhook. (required)
