...
class ActivitiesLogsApi
{
    ...
    /**
     * Operation getBigDataOperationLogs
     *
     ...
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SeaTable\Client\User\GetBigDataOperationLogs200Response
     */
    public function getBigDataOperationLogs($base_uuid, $page = null, $per_page = null, string $contentType = self::contentTypes['getBigDataOperationLogs'][0])
    {
        list($response) = $this->getBigDataOperationLogsWithHttpInfo($base_uuid, $page, $per_page, $contentType);
        return $response;
    }

    /**
     * Operation getBigDataOperationLogsWithHttpInfo
     *
     * Get Big Data Operation Logs
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SeaTable\Client\User\GetBigDataOperationLogs200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBigDataOperationLogsWithHttpInfo($base_uuid, $page = null, $per_page = null, string $contentType = self::contentTypes['getBigDataOperationLogs'][0])
    {
        $request = $this->getBigDataOperationLogsRequest($base_uuid, $page, $per_page, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SeaTable\Client\User\GetBigDataOperationLogs200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SeaTable\Client\User\GetBigDataOperationLogs200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SeaTable\Client\User\GetBigDataOperationLogs200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\SeaTable\Client\User\GetBigDataOperationLogs200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SeaTable\Client\User\GetBigDataOperationLogs200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getBigDataOperationLogsAsync
     *
     * Get Big Data Operation Logs
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBigDataOperationLogsAsync($base_uuid, $page = null, $per_page = null, string $contentType = self::contentTypes['getBigDataOperationLogs'][0])
    {
        return $this->getBigDataOperationLogsAsyncWithHttpInfo($base_uuid, $page, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBigDataOperationLogsAsyncWithHttpInfo
     *
     * Get Big Data Operation Logs
     *
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBigDataOperationLogsAsyncWithHttpInfo($base_uuid, $page = null, $per_page = null, string $contentType = self::contentTypes['getBigDataOperationLogs'][0])
    {
        $returnType = '\SeaTable\Client\User\GetBigDataOperationLogs200Response';
        $request = $this->getBigDataOperationLogsRequest($base_uuid, $page, $per_page, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBigDataOperationLogsRequest($base_uuid, $page = null, $per_page = null, string $contentType = self::contentTypes['getBigDataOperationLogs'][0])
    {

        // verify the required parameter 'base_uuid' is set
        if ($base_uuid === null || (is_array($base_uuid) && count($base_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_uuid when calling getBigDataOperationLogs'
            );
        }
        if (!preg_match("/^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/", $base_uuid)) {
            throw new \InvalidArgumentException("invalid value for \"base_uuid\" when calling ActivitiesLogsApi.getBigDataOperationLogs, must conform to the pattern /^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/.");
        }
        
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling ActivitiesLogsApi.getBigDataOperationLogs, must be bigger than or equal to 1.');
        }
        
        if ($per_page !== null && $per_page < 1) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling ActivitiesLogsApi.getBigDataOperationLogs, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/api/v2.1/dtables/{base_uuid}/big-data-operation-logs/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
