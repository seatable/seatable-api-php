...
class StatisticsApi
{
     ...
     *
     * @param  string|null $start Starting time of the statistics like in the example. Required. (optional)
     * @param  string|null $end Ending time of the statistics like in the example. Required. (optional)
    ...
    public function getActiveUsersPerDayRequest($start = null, $end = null, string $contentType = self::contentTypes['getActiveUsersPerDay'][0])
    {
        ...
        if ($start !== null && !preg_match("/^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}$/", $start)) {
            throw new \InvalidArgumentException("invalid value for \"start\" when calling StatisticsApi.getActiveUsersPerDay, must conform to the pattern /^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}$/.");
        }
        
        if ($end !== null && !preg_match("/^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}$/", $end)) {
            throw new \InvalidArgumentException("invalid value for \"end\" when calling StatisticsApi.getActiveUsersPerDay, must conform to the pattern /^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}$/.");
        }
     ...
     * @param  string|null $month For which month you&#39;d like to list the statistics in the format of YYYYMM. Statistics of automation rules before 202109 are not correctly summarized. (optional)
     ...
     * @param  int|null $page The page number you want to start showing the entries. If no value is provided, 1 will be used. (optional)
     * @param  int|null $per_page The number of results that should be returned. If no value is provided, 25 results will be returned. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOwnerOrTeamAIStatistics'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object
     */
    public function getOwnerOrTeamAIStatistics($group_by, $date, $page = null, $per_page = null, string $contentType = self::contentTypes['getOwnerOrTeamAIStatistics'][0])
    {
        list($response) = $this->getOwnerOrTeamAIStatisticsWithHttpInfo($group_by, $date, $page, $per_page, $contentType);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOwnerOrTeamAIStatisticsWithHttpInfo($group_by, $date, $page = null, $per_page = null, string $contentType = self::contentTypes['getOwnerOrTeamAIStatistics'][0])
    {
        $request = $this->getOwnerOrTeamAIStatisticsRequest($group_by, $date, $page, $per_page, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOwnerOrTeamAIStatisticsAsync($group_by, $date, $page = null, $per_page = null, string $contentType = self::contentTypes['getOwnerOrTeamAIStatistics'][0])
    {
        return $this->getOwnerOrTeamAIStatisticsAsyncWithHttpInfo($group_by, $date, $page, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOwnerOrTeamAIStatisticsAsyncWithHttpInfo($group_by, $date, $page = null, $per_page = null, string $contentType = self::contentTypes['getOwnerOrTeamAIStatistics'][0])
    {
        $returnType = 'object';
        $request = $this->getOwnerOrTeamAIStatisticsRequest($group_by, $date, $page, $per_page, $contentType);
    ...
    /**
     * Create request for operation 'getOwnerOrTeamAIStatistics'
     *
     * @param  string $group_by Query by owner or organization (required)
     * @param  string $date A date string in YYYY-MM-DD format (required)
     * @param  int|null $page The page number you want to start showing the entries. If no value is provided, 1 will be used. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOwnerOrTeamAIStatisticsRequest($group_by, $date, $page = null, $per_page = null, string $contentType = self::contentTypes['getOwnerOrTeamAIStatistics'][0])
    {

        // verify the required parameter 'group_by' is set
        if ($group_by === null || (is_array($group_by) && count($group_by) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $group_by when calling getOwnerOrTeamAIStatistics'
            );
        }
        ...
        if ($date === null || (is_array($date) && count($date) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $date when calling getOwnerOrTeamAIStatistics'
            );
        }

        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling StatisticsApi.getOwnerOrTeamAIStatistics, must be bigger than or equal to 1.');
        }
        
        if ($per_page !== null && $per_page < 1) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling StatisticsApi.getOwnerOrTeamAIStatistics, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/api/v2.1/admin/statistics/ai/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  bool $is_user Whether you&#39;d like to list automation rules triggered by single users who are not in any teams (&#x60;true&#x60;) or by teams (&#x60;false&#x60;).  The usage of &#x60;true&#x60; here is seldom meaningful for cloud.seatable.io as all the users in the SeaTable Cloud are team users. (required)
     * @param  string|null $owner The ID of the user you are querying. Optional. If you don&#39;t define a user, all the users are queried. (optional)
     * @param  string|null $month For which month you&#39;d like to list the statistics in the format of YYYYMM. Statistics of automation rules before 202109 are not correctly summarized. (optional)
     ...
     *
     * @param  string|null $date The date. Required. (optional)
     * @param  int|null $page The page number you want to start showing the entries. If no value is provided, 1 will be used. (optional)
     * @param  int|null $per_page The number of results that should be returned. If no value is provided, 25 results will be returned. (optional)
    ...
    public function listActiveUsersByDayRequest($date = null, $page = null, $per_page = null, string $contentType = self::contentTypes['listActiveUsersByDay'][0])
    {
        ...
        if ($date !== null && !preg_match("/^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}$/", $date)) {
            throw new \InvalidArgumentException("invalid value for \"date\" when calling StatisticsApi.listActiveUsersByDay, must conform to the pattern /^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}$/.");
        }
