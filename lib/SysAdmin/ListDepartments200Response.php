...
class ListDepartments200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'groups' => 'setGroups',
        'members' => 'setMembers',
        'ancestor_groups' => 'setAncestorGroups'
    ];
    ...
    protected static $getters = [
        ...
        'groups' => 'getGroups',
        'members' => 'getMembers',
        'ancestor_groups' => 'getAncestorGroups'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ancestor_groups', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets ancestor_groups
     *
     * @return object[]|null
     */
    public function getAncestorGroups()
    {
        return $this->container['ancestor_groups'];
    }

    /**
     * Sets ancestor_groups
     *
     * @param object[]|null $ancestor_groups ancestor_groups
     *
     * @return self
     */
    public function setAncestorGroups($ancestor_groups)
    {
        if (is_null($ancestor_groups)) {
            throw new \InvalidArgumentException('non-nullable ancestor_groups cannot be null');
        }
        $this->container['ancestor_groups'] = $ancestor_groups;
