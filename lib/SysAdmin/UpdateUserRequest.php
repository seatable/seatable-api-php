...
class UpdateUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets role
     *
     * @param string|null $role Update their role. For details about roles, refer to [SeaTable Roles and Permissions](https://admin.seatable.com/configuration/roles-and-permissions/).
     *
     * @return self
     */
     ...
     *
     * @param int|null $monthly_automation_limit_per_user Monthly limit on the number of automation rules per user.
     *
     * @return self
     */
