...
class TeamsApi
{
     ...
     * Add Team
     *
     * @param  \SeaTable\Client\SysAdmin\AddTeamRequest|null $add_team_request add_team_request (optional)
     ...
     * Add Team
     *
     * @param  \SeaTable\Client\SysAdmin\AddTeamRequest|null $add_team_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addTeam'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $name Full name of the user. (optional)
     ...
     * @param  int|null $page The page number you want to start showing the entries. If no value is provided, 1 will be used. (optional)
     * @param  int|null $per_page The number of results that should be returned. If no value is provided, 25 results will be returned. (optional)
     * @param  string|null $role Optional. When left blank, all role types are returned. (optional)
     ...
     *
     * @param  int $org_id The id of your team/organization. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     * @param  \SeaTable\Client\SysAdmin\UpdateTeamRequest|null $update_team_request update_team_request (optional)
     ...
     *
     * @param  int $org_id The id of your team/organization. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     * @param  \SeaTable\Client\SysAdmin\UpdateTeamRequest|null $update_team_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateTeam'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  int $org_id The id of your team/organization. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     * @param  string $user_id The unique user id in the form ...@auth.local. This is not the email address of the user. (required)
     * @param  \SeaTable\Client\SysAdmin\UpdateTeamUserRequest|null $update_team_user_request update_team_user_request (optional)
     ...
     * @param  int $org_id The id of your team/organization. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     * @param  string $user_id The unique user id in the form ...@auth.local. This is not the email address of the user. (required)
     * @param  \SeaTable\Client\SysAdmin\UpdateTeamUserRequest|null $update_team_user_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateTeamUser'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
