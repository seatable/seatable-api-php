...
class BasesApi
{
    ...
    {
        list($response) = $this->listAllBasesWithHttpInfo($per_page, $page, $contentType);
        return $response;
    }
     ...
     * @param  string|null $username Who you want to get the notifications of, optional (optional)
     * @param  string|null $contact_email The contact email of the user you&#39;re querying. Optional if &#x60;username&#x60; is defined. (optional)
     * @param  int|null $seen Seen status, whether seen or not, 0/1, optional (optional)
     * @param  int|null $page The page number you want to start showing the entries. If no value is provided, 1 will be used. (optional)
     * @param  int|null $per_page The number of results that should be returned. If no value is provided, 25 results will be returned. (optional)
