...
class GroupsApi
{
     ...
     * Create Group
     *
     * @param  \SeaTable\Client\SysAdmin\CreateGroupRequest|null $create_group_request create_group_request (optional)
     ...
     * Create Group
     *
     * @param  \SeaTable\Client\SysAdmin\CreateGroupRequest|null $create_group_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createGroup'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string|null $name Enter any query string from the name of the group. (optional)
