...
class ActivitiesLogsApi
{
    ...
    public function listPythonRunsRequest($org_id, $dtable_uuid = null, $start = null, $end = null, $page = null, $per_page = null, string $contentType = self::contentTypes['listPythonRuns'][0])
    {
        ...
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling listPythonRuns'
            );
        }
        if ($org_id < 1) {
     ...
     * @param  int|null $page The page number you want to start showing the entries. If no value is provided, 1 will be used. (optional)
     * @param  int|null $per_page The number of results that should be returned. If no value is provided, 25 results will be returned. (optional)
     * @param  string|null $status Set this to &#x60;success&#x60; to only return successful logins. By default, all logins are returned. (optional)
     * @param  \DateTime|null $start Start date in ISO format. (optional)
     * @param  \DateTime|null $end End date in ISO format. (optional)
     ...
     * @return object
     */
    public function listTeamLogins($org_id, $page = null, $per_page = null, $status = null, $start = null, $end = null, string $contentType = self::contentTypes['listTeamLogins'][0])
    {
        list($response) = $this->listTeamLoginsWithHttpInfo($org_id, $page, $per_page, $status, $start, $end, $contentType);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function listTeamLoginsWithHttpInfo($org_id, $page = null, $per_page = null, $status = null, $start = null, $end = null, string $contentType = self::contentTypes['listTeamLogins'][0])
    {
        $request = $this->listTeamLoginsRequest($org_id, $page, $per_page, $status, $start, $end, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listTeamLoginsAsync($org_id, $page = null, $per_page = null, $status = null, $start = null, $end = null, string $contentType = self::contentTypes['listTeamLogins'][0])
    {
        return $this->listTeamLoginsAsyncWithHttpInfo($org_id, $page, $per_page, $status, $start, $end, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listTeamLoginsAsyncWithHttpInfo($org_id, $page = null, $per_page = null, $status = null, $start = null, $end = null, string $contentType = self::contentTypes['listTeamLogins'][0])
    {
        $returnType = 'object';
        $request = $this->listTeamLoginsRequest($org_id, $page, $per_page, $status, $start, $end, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listTeamLoginsRequest($org_id, $page = null, $per_page = null, $status = null, $start = null, $end = null, string $contentType = self::contentTypes['listTeamLogins'][0])
    {
