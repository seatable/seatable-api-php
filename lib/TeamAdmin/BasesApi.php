...
class BasesApi
{
     ...
     * @return object
     */
    public function deleteBase($org_id, $base_uuid, string $contentType = self::contentTypes['deleteBase'][0])
    {
        list($response) = $this->deleteBaseWithHttpInfo($org_id, $base_uuid, $contentType);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteBaseWithHttpInfo($org_id, $base_uuid, string $contentType = self::contentTypes['deleteBase'][0])
    {
        $request = $this->deleteBaseRequest($org_id, $base_uuid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteBaseAsync($org_id, $base_uuid, string $contentType = self::contentTypes['deleteBase'][0])
    {
        return $this->deleteBaseAsyncWithHttpInfo($org_id, $base_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteBaseAsyncWithHttpInfo($org_id, $base_uuid, string $contentType = self::contentTypes['deleteBase'][0])
    {
        $returnType = 'object';
        $request = $this->deleteBaseRequest($org_id, $base_uuid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteBaseRequest($org_id, $base_uuid, string $contentType = self::contentTypes['deleteBase'][0])
    {
        ...
        $resourcePath = '/api/v2.1/org/{org_id}/admin/dtables/{base_uuid}/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getBase'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->getBaseWithHttpInfo($org_id, $base_uuid, $contentType);
        return $response;
    }

    /**
     * Operation getBaseWithHttpInfo
     *
     * Get Base
     *
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBaseAsync($org_id, $base_uuid, string $contentType = self::contentTypes['getBase'][0])
    {
        return $this->getBaseAsyncWithHttpInfo($org_id, $base_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getBaseAsyncWithHttpInfo
     *
     * Get Base
     *
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
    ...
    /**
     * Create request for operation 'getBase'
     *
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     * @param  string $base_uuid The unique identifier of a base. Sometimes also called dtable_uuid. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getBase'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBaseRequest($org_id, $base_uuid, string $contentType = self::contentTypes['getBase'][0])
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling getBase'
            );
        }
        if ($org_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$org_id" when calling BasesApi.getBase, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'base_uuid' is set
        if ($base_uuid === null || (is_array($base_uuid) && count($base_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_uuid when calling getBase'
            );
        }
        if (!preg_match("/^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/", $base_uuid)) {
            throw new \InvalidArgumentException("invalid value for \"base_uuid\" when calling BasesApi.getBase, must conform to the pattern /^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/.");
        }
    ...
    {
        list($response) = $this->listBaseSharingsWithHttpInfo($org_id, $base_uuid, $contentType);
        return $response;
    }
     ...
     * @return object
     */
    public function listBasesSharedToUser($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listBasesSharedToUser'][0])
    {
        list($response) = $this->listBasesSharedToUserWithHttpInfo($org_id, $user_id, $page, $per_page, $contentType);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function listBasesSharedToUserWithHttpInfo($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listBasesSharedToUser'][0])
    {
        $request = $this->listBasesSharedToUserRequest($org_id, $user_id, $page, $per_page, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listBasesSharedToUserAsync($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listBasesSharedToUser'][0])
    {
        return $this->listBasesSharedToUserAsyncWithHttpInfo($org_id, $user_id, $page, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listBasesSharedToUserAsyncWithHttpInfo($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listBasesSharedToUser'][0])
    {
        $returnType = 'object';
        $request = $this->listBasesSharedToUserRequest($org_id, $user_id, $page, $per_page, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listBasesSharedToUserRequest($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listBasesSharedToUser'][0])
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling listBasesSharedToUser'
            );
        }
        if ($org_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$org_id" when calling BasesApi.listBasesSharedToUser, must be bigger than or equal to 1.');
        }
        ...
        if (!preg_match("/^[a-f0-9]{32}(@auth.local)$/", $user_id)) {
            throw new \InvalidArgumentException("invalid value for \"user_id\" when calling BasesApi.listBasesSharedToUser, must conform to the pattern /^[a-f0-9]{32}(@auth.local)$/.");
        }
        
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling BasesApi.listBasesSharedToUser, must be bigger than or equal to 1.');
        }
        
        if ($per_page !== null && $per_page < 1) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling BasesApi.listBasesSharedToUser, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/api/v2.1/org/{org_id}/admin/users/{user_id}/shared-dtables/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return object
     */
    public function restoreBaseFromTrash($org_id, $base_uuid, string $contentType = self::contentTypes['restoreBaseFromTrash'][0])
    {
        list($response) = $this->restoreBaseFromTrashWithHttpInfo($org_id, $base_uuid, $contentType);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function restoreBaseFromTrashWithHttpInfo($org_id, $base_uuid, string $contentType = self::contentTypes['restoreBaseFromTrash'][0])
    {
        $request = $this->restoreBaseFromTrashRequest($org_id, $base_uuid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restoreBaseFromTrashAsync($org_id, $base_uuid, string $contentType = self::contentTypes['restoreBaseFromTrash'][0])
    {
        return $this->restoreBaseFromTrashAsyncWithHttpInfo($org_id, $base_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restoreBaseFromTrashAsyncWithHttpInfo($org_id, $base_uuid, string $contentType = self::contentTypes['restoreBaseFromTrash'][0])
    {
        $returnType = 'object';
        $request = $this->restoreBaseFromTrashRequest($org_id, $base_uuid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function restoreBaseFromTrashRequest($org_id, $base_uuid, string $contentType = self::contentTypes['restoreBaseFromTrash'][0])
    {
        ...
        if ($base_uuid === null || (is_array($base_uuid) && count($base_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $base_uuid when calling restoreBaseFromTrash'
            );
        }
        if (!preg_match("/^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/", $base_uuid)) {
            throw new \InvalidArgumentException("invalid value for \"base_uuid\" when calling BasesApi.restoreBaseFromTrash, must conform to the pattern /^[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$/.");
        }
        

        $resourcePath = '/api/v2.1/org/{org_id}/admin/trash-dtables/{base_uuid}/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     * @param  string|null $query Exact name or a part of the name of the base, case insensitive. (optional)
