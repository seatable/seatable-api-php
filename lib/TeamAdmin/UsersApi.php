...
class UsersApi
{
     ...
     * @return \SeaTable\Client\TeamAdmin\AddUser200Response
     */
     ...
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SeaTable\Client\TeamAdmin\AddUser200Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SeaTable\Client\TeamAdmin\AddUser200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\SeaTable\Client\TeamAdmin\AddUser200Response';
        $request = $this->addUserRequest($org_id, $email, $name, $password, $with_workspace, $contentType);
     ...
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SeaTable\Client\TeamAdmin\GetUser200Response
     */
    public function getUser($org_id, $user_id, string $contentType = self::contentTypes['getUser'][0])
    {
        list($response) = $this->getUserWithHttpInfo($org_id, $user_id, $contentType);
        return $response;
    }
     ...
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SeaTable\Client\TeamAdmin\GetUser200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserWithHttpInfo($org_id, $user_id, string $contentType = self::contentTypes['getUser'][0])
    {
        $request = $this->getUserRequest($org_id, $user_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SeaTable\Client\TeamAdmin\GetUser200Response',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAsync($org_id, $user_id, string $contentType = self::contentTypes['getUser'][0])
    {
        return $this->getUserAsyncWithHttpInfo($org_id, $user_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAsyncWithHttpInfo($org_id, $user_id, string $contentType = self::contentTypes['getUser'][0])
    {
        $returnType = '\SeaTable\Client\TeamAdmin\GetUser200Response';
        $request = $this->getUserRequest($org_id, $user_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUserRequest($org_id, $user_id, string $contentType = self::contentTypes['getUser'][0])
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling getUser'
            );
        }
        if ($org_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$org_id" when calling UsersApi.getUser, must be bigger than or equal to 1.');
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listManagedApps'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object
     */
    public function listManagedApps($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listManagedApps'][0])
    {
        list($response) = $this->listManagedAppsWithHttpInfo($org_id, $user_id, $page, $per_page, $contentType);
        return $response;
    }

    /**
     * Operation listManagedAppsWithHttpInfo
     *
     * List Managed Apps
     *
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function listManagedAppsWithHttpInfo($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listManagedApps'][0])
    {
        $request = $this->listManagedAppsRequest($org_id, $user_id, $page, $per_page, $contentType);
    ...
    /**
     * Operation listManagedAppsAsync
     *
     * List Managed Apps
     *
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listManagedAppsAsync($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listManagedApps'][0])
    {
        return $this->listManagedAppsAsyncWithHttpInfo($org_id, $user_id, $page, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listManagedAppsAsyncWithHttpInfo($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listManagedApps'][0])
    {
        $returnType = 'object';
        $request = $this->listManagedAppsRequest($org_id, $user_id, $page, $per_page, $contentType);
    ...
    /**
     * Create request for operation 'listManagedApps'
     *
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     * @param  string $user_id The unique &#x60;user_id&#x60; in the form ...@auth.local. This is not the email address of the user. (required)
     * @param  int|null $page The page number you want to start showing the entries. If no value is provided, 1 will be used. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listManagedAppsRequest($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listManagedApps'][0])
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling listManagedApps'
            );
        }
        if ($org_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$org_id" when calling UsersApi.listManagedApps, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_id when calling listManagedApps'
            );
        }
        if (!preg_match("/^[a-f0-9]{32}(@auth.local)$/", $user_id)) {
            throw new \InvalidArgumentException("invalid value for \"user_id\" when calling UsersApi.listManagedApps, must conform to the pattern /^[a-f0-9]{32}(@auth.local)$/.");
        }
        
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling UsersApi.listManagedApps, must be bigger than or equal to 1.');
        }
        
        if ($per_page !== null && $per_page < 1) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling UsersApi.listManagedApps, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/api/v2.1/org/{org_id}/admin/users/{user_id}/managed-external-apps/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int|null $page The page number you want to start showing the entries. If no value is provided, 1 will be used. (optional)
     * @param  int|null $per_page The number of results that should be returned. If no value is provided, 25 results will be returned. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listUsableApps'] to see the possible values for this operation
     *
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return object
     */
    public function listUsableApps($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listUsableApps'][0])
    {
        list($response) = $this->listUsableAppsWithHttpInfo($org_id, $user_id, $page, $per_page, $contentType);
        return $response;
    }

    /**
     * Operation listUsableAppsWithHttpInfo
     *
     * List Usable Apps
     *
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function listUsableAppsWithHttpInfo($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listUsableApps'][0])
    {
        $request = $this->listUsableAppsRequest($org_id, $user_id, $page, $per_page, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listUsableAppsAsync($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listUsableApps'][0])
    {
        return $this->listUsableAppsAsyncWithHttpInfo($org_id, $user_id, $page, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listUsableAppsAsyncWithHttpInfo
     *
     * List Usable Apps
     *
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listUsableAppsAsyncWithHttpInfo($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listUsableApps'][0])
    {
        $returnType = 'object';
        $request = $this->listUsableAppsRequest($org_id, $user_id, $page, $per_page, $contentType);
    ...
    /**
     * Create request for operation 'listUsableApps'
     *
     * @param  int $org_id The ID of your team/organization. Numeric. Get it from [Get Team](/reference/getteaminfo). Contact your team admin, if you are not the admin. (required)
     * @param  string $user_id The unique &#x60;user_id&#x60; in the form ...@auth.local. This is not the email address of the user. (required)
     * @param  int|null $page The page number you want to start showing the entries. If no value is provided, 1 will be used. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listUsableAppsRequest($org_id, $user_id, $page = null, $per_page = null, string $contentType = self::contentTypes['listUsableApps'][0])
    {

        // verify the required parameter 'org_id' is set
        if ($org_id === null || (is_array($org_id) && count($org_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $org_id when calling listUsableApps'
            );
        }
        if ($org_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$org_id" when calling UsersApi.listUsableApps, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_id when calling listUsableApps'
            );
        }
        if (!preg_match("/^[a-f0-9]{32}(@auth.local)$/", $user_id)) {
            throw new \InvalidArgumentException("invalid value for \"user_id\" when calling UsersApi.listUsableApps, must conform to the pattern /^[a-f0-9]{32}(@auth.local)$/.");
        }
        
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling UsersApi.listUsableApps, must be bigger than or equal to 1.');
        }
        
        if ($per_page !== null && $per_page < 1) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling UsersApi.listUsableApps, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/api/v2.1/org/{org_id}/admin/users/{user_id}/can-use-external-apps/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SeaTable\Client\TeamAdmin\UpdateUser200Response
     */
     ...
     * @throws \SeaTable\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SeaTable\Client\TeamAdmin\UpdateUser200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateUserWithHttpInfo($org_id, $user_id, $name = null, $contact_email = null, $is_staff = null, $is_active = null, $quota_total = null, $id_in_org = null, string $contentType = self::contentTypes['updateUser'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SeaTable\Client\TeamAdmin\UpdateUser200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\SeaTable\Client\TeamAdmin\UpdateUser200Response';
        $request = $this->updateUserRequest($org_id, $user_id, $name, $contact_email, $is_staff, $is_active, $quota_total, $id_in_org, $contentType);
