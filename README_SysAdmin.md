...
*LogsApi* | [**deleteVirusFile**](docs/SysAdmin/Api/LogsApi.md#deletevirusfile) | **DELETE** /api/v2.1/admin/virus-files/{virus_id}/ | Delete Virus File
...
*LogsApi* | [**updateVirusFile**](docs/SysAdmin/Api/LogsApi.md#updatevirusfile) | **PUT** /api/v2.1/admin/virus-files/{virus_id}/ | Update Virus File
